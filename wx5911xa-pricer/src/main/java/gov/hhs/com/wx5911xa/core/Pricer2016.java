...
public class Pricer2016 implements iPricer {
  private WageIndexMap wageIndexMap;
  private CaseMixGroupCodeTable cmgTable;

  private static final String PRICER_VERSION_2016 = "V16.0";
  ...
  private static final BigDecimal NATIONAL_LABOR_PERCENTAGE = BigDecimal.valueOf(0.71000);
  private static final BigDecimal NATIONAL_NON_LABOR_PERCENTAGE = BigDecimal.valueOf(0.29000);
  private static final BigDecimal NATIONAL_THRESHOLD_ADJUSTMENT = BigDecimal.valueOf(8658.00);
  private static final BigDecimal BUDGET_NEUTRAL_CONVERSION_AMOUNT = BigDecimal.valueOf(15478.00);
  private static final BigDecimal BUDGET_NEUTRAL_CONVERSION_AMOUNT2 = BigDecimal.valueOf(15174.00);
  private static final BigDecimal RURAL_ADJUSTMENT = BigDecimal.valueOf(1.0993);
  ...
  public Pricer2016(WageIndexMap wageIndexMap, CaseMixGroupCodeTable cmgTable) {
