...
public class Pricer2015 implements iPricer {
  private WageIndexMap wageIndexMap;
  private CaseMixGroupCodeTable cmgTable;

  private static final String PRICER_VERSION_2015 = "V15.0";
  ...
  private static final BigDecimal NATIONAL_LABOR_PERCENTAGE = BigDecimal.valueOf(0.69294);
  private static final BigDecimal NATIONAL_NON_LABOR_PERCENTAGE = BigDecimal.valueOf(0.30706);
  private static final BigDecimal NATIONAL_THRESHOLD_ADJUSTMENT = BigDecimal.valueOf(8848.00);
  private static final BigDecimal BUDGET_NEUTRAL_CONVERSION_AMOUNT = BigDecimal.valueOf(15198.00);
  private static final BigDecimal BUDGET_NEUTRAL_CONVERSION_AMOUNT2 = BigDecimal.valueOf(14901.00);
  private static final BigDecimal RURAL_ADJUSTMENT = BigDecimal.ZERO;
  ...
  public Pricer2015(WageIndexMap wageIndexMap, CaseMixGroupCodeTable cmgTable) {
